...
function user_setup()
	state.RangedMode:options('Normal', 'Acc', 'Bow', 'XBow', 'Gun')
	state.WeaponskillMode:options('Normal', 'Acc', 'Magic')
	...
	if state.RangedMode=='Bow' then
		send_command('bind @q input /ws "Refulgent Arrow" <t>')
	end
end
