...
function user_setup()
    ...
    send_command('bind !q input /equip main "Aizushintogo"; input /equip sub "Jushimatsu";')
	send_command('bind @3 input /ma "Utsusemi: San" <me>; input /echo this; input /echo that;')
	send_command('bind @2 input /ma "Utsusemi: Ni" <me>;')
	send_command('bind @1 input /ma "Utsusemi: Ichi" <me>;')
	send_command('bind @4 input /ma "Migawari: Ichi" <me>;') --severely dmg atk
	send_command('bind @5 input /item "Remedy" <me>;')
	send_command('bind @6 input /ma "Kakka: Ichi" <me>;') --tp plus
	send_command('bind @7 input /ma "Yurin: Ichi" <t>;') --tp minus for enemy
	send_command('bind @8 input /ma "Myoshu: Ichi" <me>;') --subtle blow +
	send_command('bind @9 input /ma "Aisha: Ichi" <t>;') --atk down for enemy
...
function init_gear_sets()
    ...
    sets.precast.WS['Blade: Jin'] = set_combine(sets.precast.WS,
        {neck="Rancor Collar",ear1="Brutal Earring",ear2="Moonshade Earring",feet="Daihanshi Habaki",neck=gear.ElementalGorget,waist=gear.ElementalBelt})
	...
	sets.precast.WS['Blade: Ten'] = set_combine(sets.precast.WS,
        {neck="Rancor Collar",ear1="Ishvara Earring",ear2="Moonshade Earring"})
    ...
    sets.idle.Town = {main="Raimitsukane",sub="Kaitsuburi",ammo="Qirmiz Tathlum",
        head="Whirlpool Mask",neck="Wiglen Gorget",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
        body="Hachiya Chainmail +1",hands="Otronif Gloves",ring1="Sheltered Ring",ring2="Paguroidea Ring",
        back="Andartia's Mantle",waist="Patentia Sash",legs="Hachiya Hakama",feet=gear.MovementFeet}
    ...
    sets.engaged.Acc = {ammo="Happo Shuriken",
        head="Whirlpool Mask",neck="Ninja Nodowa",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
    ...
    sets.engaged.Evasion = {ammo="Qirmiz Tathlum",
        ...
        back="Relucent Cape",waist="Patentia Sash",legs="Hachiya Hakama",feet="Otronif Boots +1"}
    sets.engaged.Acc.Evasion = {ammo="Qirmiz Tathlum",
        ...
        back="Relucent Cape",waist="Hurch'lan Sash",legs="Hachiya Hakama",feet="Otronif Boots +1"}
    ...
    sets.engaged.HighHaste = {ammo="Happo Shuriken",
        ...
        back="Andartia's Mantle",waist="Patentia Sash",legs="Hachiya Hakama",feet="Manibozho Boots"}
    ...
    sets.engaged.EmbravaHaste = {ammo="Happo Shuriken",
        ...
        back="Andartia's Mantle",waist="Windbuffet Belt",legs="Manibozho Brais",feet="Manibozho Boots"}
    ...
    sets.engaged.MaxHaste = {ammo="Happo Shuriken",
        head="Mpaca's Cap",neck="Ninja Nodowa",ear1="Bladeborn Earring",ear2="Steelflash Earring",
        body="Mpaca's Doublet",hands="Mpaca's Gloves",ring1="Chirich Ring",ring2="Epona's Ring",
        back="Andartia's Mantle",waist="Sailfi Belt +1",legs="Mpaca's Hose",feet="Mpaca's Boots"}
