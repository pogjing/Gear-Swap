...
--	send_command('bind = @a input /ja "Activate" <me>')
--	send_command('bind = !a input /ja "Deus Ex Automata" <me>')
...
function init_gear_sets()
    ...
    sets.idle.Pet.Engaged = {
		...
		ring1="Varar Ring",
		ring2="Varar Ring",
        back={ name="Visucius's Mantle", augments={'Pet: Acc.+20 Pet: R.Acc.+20 Pet: Atk.+20 Pet: R.Atk.+20','Accuracy+10 Attack+10','Pet: "Regen"+10','System: 1 ID: 1247 Val: 4',}},
		waist="Klouskap Sash",
