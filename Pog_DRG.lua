...
function user_setup()
    state.OffenseMode:options('Normal', 'NYA', 'Acc', 'LowAcc', 'MidAcc', 'HighAcc', 'MaxAcc', 'STP')
    state.WeaponskillMode:options('Normal', 'Acc')
    state.HybridMode:options('Normal', 'DT')
    state.IdleMode:options('Normal', 'TP', 'DT')
...
function init_gear_sets()
    ...
    sets.precast.JA['Jump'] = {
        ...
        legs="Ptero. Brais +3",
        feet="Vishap Greaves +1",--"Ostro Greaves",
        neck="Anu Torque",
        ear1="Sherida Earring",
        ear2="Telos Earring",
        ring1="Niqmaddu Ring",
        ring2={name="Chirich Ring +1", bag="wardrobe3"},
        back="Brigantia's Mantle",--gear.DRG_JMP_Cape,
...
--[[    sets.engaged = {
	...
	sets.engaged = {
		ammo="Coiste Bodhar",
		--head={ name="Acro Helm", augments={'Accuracy+20 Attack+20','"Dbl.Atk."+3','STR+5 DEX+5',}},
		head="Flamma Zucchetto +2",
		body="Vatic Byrnie",
		hands="Sulevia's Gauntlets +2",
		legs="Sulevia's Cuisses +2",
		feet="Flamma Gambieras +2",
		--feet={ name="Acro Leggings", augments={'Accuracy+19 Attack+19','"Dbl.Atk."+2','STR+7 AGI+7',}},
