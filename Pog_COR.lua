...
function user_setup()
    ...
    --gear.RAbullet = "Adlivun Bullet" --replaced all instances of this bullet with corsair
	...
	send_command('bind @` input /ja "Corsair\'s Roll" <me>')
	send_command('bind @1 input /ja "Samurai Roll" <me>')
	send_command('bind @2 input /ja "Fighter\'s Roll" <me>')
	send_command('bind @3 input /ja "Evoker\'s Roll" <me>')
	send_command('bind @4 input /ja "Hunter\'s Roll" <me>')
	send_command('bind @5 input /ja "Chaos Roll" <me>')
	send_command('bind @6 input /ja "Dancer\'s Roll" <me>')
...
function init_gear_sets()
    ...
    sets.precast.CorsairRoll = {head="Lanun Tricorne +1",hands="Navarch's Gants +2"}
    ...
    sets.engaged.Ranged = {ammo=gear.RAbullet,
        head="Nyame Helm",neck="Twilight Torque",ear1="Clearview Earring",ear2="Volley Earring",
