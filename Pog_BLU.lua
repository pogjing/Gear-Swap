...
send_command('bind !q input /equip main "Kaja Sword"; input /equip sub "Colada";')
...
function job_setup()
    ...
    blue_magic_maps.Magical = S{
        ...
        'Diffusion Ray','Droning Whirlwind','Embalming Earth','Entomb','Firespit','Foul Waters',
...
function user_setup()
    state.OffenseMode:options('Normal', 'Acc', 'NyaDT', 'Refresh', 'Learning', 'Cleave')
...
function init_gear_sets()
    ...
    sets.precast.Waltz = {ammo="Sonia's Plectrum",
        ...
        back="Iximulew Cape",waist="Caudata Belt",legs="Hagondes Pants",feet="Herculean Boots"}
    ...
    sets.midcast['Blue Magic'].PhysicalAcc = {ammo="Jukukik Feather",
        head="Herculean Helm",neck="Sanctity Necklace",ear1="Heartseeker Earring",ear2="Steelflash Earring",
        body="Luhlaza Jubbah",hands="Buremte Gloves",ring1="Rajas Ring",ring2="Patricius Ring",
        back="Letalis Mantle",waist="Hurch'lan Sash",legs="Manibozho Brais",feet="Herculean Boots"}
    ...
    sets.midcast['Blue Magic'].MagicAccuracy = {ammo="Mavi Tathlum",
        ...
        back="Cornflower Cape",legs="Iuitl Tights",feet="Herculean Boots"}
    ...
    sets.midcast['Blue Magic'].Breath = {ammo="Mavi Tathlum",
        ...
        back="Refraction Cape",legs="Ayanmo Cosciales",feet="Herculean Boots"}
    ...
    sets.midcast['Blue Magic']['White Wind'] = {
        head="Herculean Helm",neck="Lavalier +1",ear1="Bloodgem Earring",ear2="Loquacious Earring",
        body="Vanir Cotehardie",hands="Buremte Gloves",ring1="K'ayres Ring",ring2="Meridian Ring",
        back="Fravashi Mantle",waist="Hurch'lan Sash",legs="Ayanmo Cosciales",feet="Hagondes Sabots"}
    ...
    sets.idle.PDT = {ammo="Impatiens",
        head="Herculean Helm",neck="Wiglen Gorget",ear1="Bloodgem Earring",ear2="Loquacious Earring",
        body="Hagondes Coat",hands="Iuitl Wristbands",ring1="Defending Ring",ring2="Paguroidea Ring",
        back="Shadow Mantle",waist="Flume Belt",legs="Crimson Cuisses",feet="Herculean Boots"}
    ...
    sets.defense.PDT = {ammo="Iron Gobbet",
        head="Herculean Helm",neck="Wiglen Gorget",ear1="Bloodgem Earring",
        body="Iuitl Vest",hands="Iuitl Wristbands",ring1="Defending Ring",ring2=gear.DarkRing.physical,
        back="Shadow Mantle",waist="Flume Belt",legs="Ayanmo Cosciales",feet="Herculean Boots"}

    sets.defense.MDT = {ammo="Demonry Stone",
        head="Herculean Helm",neck="Twilight Torque",ear1="Bloodgem Earring",
        body="Hagondes Coat",hands="Iuitl Wristbands",ring1="Defending Ring",ring2="Shadow Ring",
        back="Engulfer Cape",waist="Flume Belt",legs="Ayanmo Cosciales",feet="Herculean Boots"}
    ...
    sets.engaged.Acc = {ammo="Falcon Eye",
        head="Herculean Helm",neck="Sanctity Necklace",ear1="Bladeborn Earring",ear2="Steelflash Earring",
    ...
    sets.engaged.Refresh = {ammo="Jukukik Feather",
        ...
        back="Atheling Mantle",waist="Windbuffet Belt",legs="Manibozho Brais",feet="Herculean Boots"}
    ...
    sets.engaged.DW.Acc = {ammo="Jukukik Feather",
        head="Herculean Helm",neck="Sanctity Necklace",ear1="Heartseeker Earring",ear2="Dudgeon Earring",
        body="Luhlaza Jubbah",hands="Buremte Gloves",ring1="Rajas Ring",ring2="Epona's Ring",
        back="Letalis Mantle",waist="Hurch'lan Sash",legs="Manibozho Brais",feet="Herculean Boots"}

    sets.engaged.DW.Refresh = {ammo="Jukukik Feather",
        head="Herculean Helm",neck="Asperity Necklace",ear1="Heartseeker Earring",ear2="Dudgeon Earring",
        body="Luhlaza Jubbah",hands="Assimilator's Bazubands +1",ring1="Rajas Ring",ring2="Epona's Ring",
        back="Letalis Mantle",waist="Windbuffet Belt",legs="Manibozho Brais",feet="Herculean Boots"}

	sets.engaged.DW.NyaDT = {
		ammo="Focal Orb",
		head="Nyame Helm",
		body="Nyame Mail",
		hands="Nyame Gauntlets",
